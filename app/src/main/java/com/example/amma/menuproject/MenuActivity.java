package com.example.amma.menuproject;
...
button.setOnClickListener(new View.OnClickListener() {
    ...
    public void onClick(View view) {
        ...
        String encrypted = encryption.encryptOrNull("shabeer");
        Toast.makeText(MenuActivity.this, encrypted, Toast.LENGTH_SHORT).show();
        String decrypted = encryption.decryptOrNull(encrypted);

        Toast.makeText(MenuActivity.this, decrypted, Toast.LENGTH_SHORT).show();
*/
        ...
        for (int h = 0; h < input.length(); h++) {
            ...
            in= input.charAt(h);
            int ascii = (int) in;
            int len = 15 - String.valueOf(ascii).length();
            ...
            Toast.makeText(MenuActivity.this, cipher_text, Toast.LENGTH_SHORT).show();
            Toast.makeText(MenuActivity.this, decrypted_msg, Toast.LENGTH_SHORT).show();
    ...
    private static int[] permute(int[] inputBits, int[] keyBits, boolean isDecrypt) {
        ...
        if(isDecrypt) {
            ...
            cipher_text=hex.toUpperCase();

        } else {
            System.out.print("Encrypted text: ");
            System.out.println(hex.toUpperCase());
            decrypted_msg=hex.toUpperCase();
        }
